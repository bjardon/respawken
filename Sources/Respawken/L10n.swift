...
enum L10n {
    ...
    private static let messages: [String: String] = [
        ...
        "Rate limited — cooling down": "Límite de peticiones — en pausa",
        "Claude refresh already in progress": "Actualización de Claude en curso",
        "Claude polling paused — waiting before retry": "Consultas de Claude en pausa — esperando para reintentar",
        "Claude polling paused — cannot read or save cooldown": "Consultas de Claude en pausa — no se puede leer o guardar la espera",
